  ...
  data () {
    return {
      ...
      validatorRules: {
        ...
        creationTime: {
          rules: [{ required: false, message: '创建时间不能为空' }, { validator: this.validateCreationTime }]
        },
        creationUserId: {
          rules: [{ required: false, message: '创建者不能为空' }, { validator: this.validateCreationUserId }]
        },
        deletionTime: {
          rules: [{ required: false, message: '删除时间不能为空' }, { validator: this.validateDeletionTime }]
        },
        deletionUserId: {
          rules: [{ required: false, message: '删除人不能为空' }, { validator: this.validateDeletionUserId }]
        },
        lastModifyTime: {
          rules: [{ required: false, message: '最后修改时间不能为空' }, { validator: this.validateLastModifyTime }]
        },
        lastModifyUserId: {
          rules: [{ required: false, message: '最后修改人不能为空' }, { validator: this.validateLastModifyUserId }]
        },
        tenantId: { rules: [{ required: false, message: '租户Id不能为空' }, { validator: this.validateTenantId }] }
      },
      urls: {
        add: '/api-grt/generatorRule',
        edit: '/api-grt/generatorRule'
      }
    }
  },
  beforeCreate () {},
