        ...
        data() {
            ...
            return {
                validatorRules: {
                    ...
                    apprCounterGuarMeasCredit: { rules: [{ required: false }, { validator: this.validateApprCounterGuarMeasCredit }]},
                    apprCounterGuarMeasMortgage: { rules: [{ required: false }, { validator: this.validateApprCounterGuarMeasMortgage }]},
                    apprCounterGuarMeasPledge: { rules: [{ required: false }, { validator: this.validateApprCounterGuarMeasPledge }]},
                    apprCounterGuarMeasGuarantee: { rules: [{ required: false }, { validator: this.validateApprCounterGuarMeasGuarantee }]},
                    apprCounterGuarMeasByPro: { rules: [{ required: false }, { validator: this.validateApprCounterGuarMeasByPro }]},
                    apprCounterGuarMeasOther: { rules: [{ required: false }, { validator: this.validateApprCounterGuarMeasOther }]},
                    ...
                    counterGuarMeasGuarantee: { rules: [{ required: false }, { validator: this.validateCounterGuarMeasGuarantee }]},
